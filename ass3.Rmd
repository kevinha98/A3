...
Vi sjekker så hvor mange land med registrert data mellom 1960 og 2019 det er.
...
```{r}
# Funksjonen henter ut antall "Non-availables" fra datasettet. Funksjonen er hentet fra Arnstein sin fasit. Skal vi beholde den? - Ja! (Y)
...
1. Det har vært en enorm utvikling i hvilke land og kontinent som har begynt å rapportere GDP per kapita. Vi ser fra før 1960 så var det relativt få land, mens i fra 1960 har det vært en enorm økning og utvikling på dette området.
