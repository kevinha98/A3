...
filter(year <= "1960-01-01") %>%
  ...
  geom_point() +
  coord_cartesian(ylim = c(20, 85), xlim = c(0,30000)) +
...
ggplot(mapping = aes(x = gdpPercap, y = lifeExp, size = pop, colour = continent)) +
geom_point() +
coord_cartesian(ylim = c(20, 85), xlim = c(0,50000)) +
theme(legend.position = "bottom")
```
...
ggplot(mapping = aes(x = gdpPercap, y = lifeExp, size = pop, colour = continent)) +
geom_point() +
coord_cartesian(ylim = c(20, 85), xlim = c(0,100000)) +
theme(legend.position = "bottom")
```
...
filter(year <= "1960-01-01") %>%
  ...
  geom_point() +
  coord_cartesian(ylim = c(20, 80), xlim = c(5, 11)) +
  theme(legend.position = "bottom")
```
...
filter(year <= "2000-01-01") %>%
 ggplot(mapping = aes(x = log(gdpPercap), y = lifeExp, size = pop, colour = continent)) +
  geom_point() +
  coord_cartesian(ylim = c(20, 85), xlim = c(5, 12)) +
  theme(legend.position = "bottom")
```
