...
g_c %>% # Bruker datasettet g_c
  ...
  group_by(country, gdpPercap, year) %>%
  summarise(c("country", "gdpPercap", "y")) %>% # Make a vector containing the names of the countries with the longest time series for gdp per capita.
